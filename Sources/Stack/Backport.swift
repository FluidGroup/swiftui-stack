...
/// From: https://github.com/shaps80/SwiftUIBackports/blob/main/Sources/SwiftUIBackports/Shared/StateObject/StateObject.swift
...
enum Backport {
  ...
  @propertyWrapper struct StateObject<Wrapped: ObservableObject>: DynamicProperty {
